            ...
            <div className='col-4'>
              ...
              <div>
                <address className='text-white fs-6'>
                  Nairobi: Downtown,<br/> Mfangano estate <br/>
                  Nairobi.
                </address>
                <a href="tel:+2547876554" className='mt-4 d-block mb-3 text-white'></a>
                <a href="mailto:test@gmail.com" className='mt-4 d-block mb-3 text-white'>Test@gmail.com</a>
          ...
          <div className='row'>
            <div className='col-12'>
              <p className='text-center mb-0 text-white'>
                &copy; {new Date().getFullYear()}; Powered by gilbert
              </p>
            </div>
          </div>
        </div>
